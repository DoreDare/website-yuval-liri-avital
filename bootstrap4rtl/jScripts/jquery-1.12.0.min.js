...
{ 
	...
	var what = document.forms["Form"]["Subject"];
    var note = document.forms["Form"]["Note"];
   
	if (name.value == "")
	{
        window.alert("אנא הזינו שם, שדה השם הוא שדה חובה");
    name.focus();
    return false;
}


    if (email.value == "אנא הזינו כתובת דואר אלקטרוני, שדה זה הוא שדה חובה")
	{
        window.alert("");
    email.focus();
    return false;
	...
	{
        window.alert("אנא הזינו כתובת דואר אלקטרוני תקינה, שכחת סימן שטרודל (כרוכית) ");
    email.focus();
    return false;
}
	...
	if (email.value.indexOf(".", 0) < 0)
	{
        window.alert("אנא הזינו כתובת דואר אלקטרוני תקינה, שכחת נקודה.");
    email.focus();
    return false;
}
...
if (phone.value == "")
	{
    window.alert("אנא הזינו טלפון שדה זה הוא שדה חובה ");
    phone.focus();
    return false;
}
...
//	{
//    alert("אנא בחרו את העדפתכם ליצירת קשר");
//    what.focus();
//    return false;
//}
 if (note.value == "") {
            window.alert("אנא כתבו הודעה ");
            phone.focus();
            return false;
  }
        
        send2Server(getFormValue());
return false;
}
...
function fadeDateFunc() {
    $("#activPic2").fadeTo(0, 0.5, function () { });
    $("#activPic3").fadeTo(0, 0.5, function () { });
    $("#activPic4").fadeTo(0, 0.5, function () { });
    $("#activPic5").fadeTo(0, 0.5, function () { });
    $("#activPic6").fadeTo(0, 0.5, function () { });
    $("#activPic7").fadeTo(0, 0.5, function () { });
}

function fadeCookingFunc() {
    $("#activPic1").fadeTo(0, 0.5, function () { });
    $("#activPic3").fadeTo(0, 0.5, function () { });
    $("#activPic4").fadeTo(0, 0.5, function () { });
    $("#activPic5").fadeTo(0, 0.5, function () { });
    $("#activPic6").fadeTo(0, 0.5, function () { });
...
function restoreFadeFunc() {
    $("#activPic1").fadeTo(0, 1, function () { });
    $("#activPic2").fadeTo(0, 1, function () { });
    $("#activPic3").fadeTo(0, 1, function () { });
    $("#activPic4").fadeTo(0, 1, function () { });
    $("#activPic5").fadeTo(0, 1, function () { });
    $("#activPic6").fadeTo(0, 1, function () { });
    $("#activPic7").fadeTo(0, 1, function () { });
}
...
function showCookFunc() {
    hideAll();
    $("#cooking").show();
}

function showWalkFunc() {
    hideAll();
    $("#walking").show();
}

function showMovieFunc() {
    hideAll();
    $("#movie").show();
}

function showPlayFunc() {
    hideAll();
    $("#playTogather").show();
}

function showDollFunc() {
    hideAll();
    $("#dolls").show();
}

function showCreateFunc() {
    hideAll();
    $("#creativity").show();
}
